            ...
            <div class="row">
                <div class="col-sm-12 col-md-6">
                    ...
                    <div class="form-group groupid-form-group">
                        ...
                        <input tabindex="4" id="groupId" class="form-control" type="text" value="io.redspark"
                               name="groupId">
                    </div>
                    ...
                    <div class="form-group full hidden description-form-group">
                        ...
                        <input tabindex="7" id="description" class="form-control" type="text"
                               value="Sample App project for Modelo Boot" name="description">
                    </div>
