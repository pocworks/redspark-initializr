...
public class InitializrProperties extends InitializrConfiguration {
	 ...
	 */
	@JsonIgnore
	private final SimpleElement groupId = new SimpleElement("io.redspark");
	 ...
	 */
	@JsonIgnore
	private final SimpleElement description = new SimpleElement("Sample App project for Modelo Boot");
